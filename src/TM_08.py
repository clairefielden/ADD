...
output_dir = os.join(abs_path_to_file,"CL_Results")
...
grid_file_path = os.path.join(abs_path_to_file,"ReinventCommunity/notebooks/data/DockStream/1UYD_grid.zip")
...
configuration_JSON_path = os.path.join(output_dir, "CLConfig.json")
