...
dockstream_env = os.path.expanduser("/home/brandon/.conda/envs/DockStream/bin/python")
...
docking_configuration_path = os.path.join(output_dir, "ADV_dock_1.json")
...
docking_path = output_dir + "/ADV_dock_1.json"
ligands_conformers_path = output_dir + "/ADV_embedded_ligands_1.sdf"
ligands_docked_path = output_dir + "/ADV_ligands_docked_1.sdf"
ligands_scores_path = output_dir + "/ADV_scores_1.csv"
...
configuration["logging"] = {
    ...
    "result_folder": os.path.join(output_dir, "results_1"),     # will hold the compounds (SMILES) and summaries
    "job_name": "Explorative Behaviour with Low Threshold",         # set an arbitrary job name for identification
    "job_id": "ErLT"                       # only relevant if "recipient" is set to a specific REST endpoint
}
...
configuration_JSON_path = os.path.join(output_dir, "ADV_1.json")
